...
namespace RFC.Utilities
{
    ...
    public class CRCTool
    {
        ...
        public enum CRCCode { CRC_CCITT, CRC8, CRC16, CRC32 };
        ...
        public void Init(CRCCode CodingType)
        {
            switch (CodingType)
            {
                ...
                case CRCCode.CRC32:
                    ...
                    break;
                case CRCCode.CRC8:
                    // These are the parameters we're using for robocup.  The descriptions are
                    // above, the first thing in this class.
                    order = 8;
                    direct = 1;
                    polynom = 0xD5;
                    crcinit = 0x00;
